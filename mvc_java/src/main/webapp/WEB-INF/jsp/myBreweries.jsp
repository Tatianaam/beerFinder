...
<div class="hero-body ">
	...
	<c:url var="action" value="/myBreweries" />
		...
		<div class="tile is-ancestor ">
			...
			<div class="tile is-parent is-10">
				<div class="tile is-child box">
					<a href="addBeersToBrewery">
						<h1 class="title is-4 has-text-centered ">Add beers to your Breweries</h1>
					</a>
				</div>
			</div>
			<div class="tile is-parent is-1"></div>
					...
					<article
						...
						<figure class="rating is-inline-block" style="margin: 0;">
							<c:forEach begin="0" end="4" var="step">
								<c:choose>
									<c:when
										test="${(step+.5) <=  ratings.get(brewery.brewery_id) }">
				...
				<div class="tile is-parent is-7">
					<article class="tile is-child box content is-medium">
						...
						<div>
							...
							<a href="breweryReviews?brewery_id=${brewery.brewery_id}">
								<button type="button" class="button-link button ">View
									Reviews</button>
							</a>
							<a href="breweryBeerList?brewery_id=${brewery.brewery_id}">
							<button type="button" class="button-link button ">View
								Beer List</button>
						</a>
